...
export default function ProductValidation() {
  const [products, setProducts] = useState([
    { id: 1, name: "LCD Monitor", price: 650, dateAdded: "2025-10-18", status: "pending",   image: "https://via.placeholder.com/72x72.png?text=LCD" },
    { id: 2, name: "Gaming Monitor", price: 209, dateAdded: "2025-10-18", status: "pending",   image: "https://via.placeholder.com/72x72.png?text=LCD" },
    { id: 3, name: "Nintendo", price: 150, dateAdded: "2025-10-18", status: "pending",   image: "https://via.placeholder.com/72x72.png?text=LCD" },
    { id: 4, name: "Ipad", price: 200, dateAdded: "2025-10-18", status: "pending",   image: "https://via.placeholder.com/72x72.png?text=LCD" },
  ]);
  ...
  return (
    <section className="bg-white shadow-sm rounded-lg p-6 md:p-8">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Pending items: <span className="font-medium text-gray-700">{pendingCount}</span>
      </p>
